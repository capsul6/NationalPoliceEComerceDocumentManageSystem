...
<div class="container">
  ...
  <div class="row main">
      ...
      <input type="text" class="form-control" name="outNumber" path="outNumber">

      <label>Номер вх.</label>
      <input type="text" class="form-control" name="incomeNumber" path="incomeNumber">

      <label>Дата вх.</label>
      <input type="date" class="form-control" name="incomingDate" path="incomingDate">

      <label>Дата вих.</label>
      <input type="date" class="form-control" name="outDate" path="outDate">

      <label>П.І.Б та адреса заявника</label>
      <input type="text" class="form-control" name="nameAndAddressOfApplicant" path="nameAndAddressOfApplicant">
      ...
      <input type="text" class="form-control" name="nameOfDepute" path="nameOfDepute">

      <label>Інстанція з якої надійшов документ</label>
      <input type="text" class="form-control" name="sendingOrganization" path="sendingOrganization">

      <label>Короткий зміст</label>
      <textarea class="form-control" name="shortContentOfAppeal" path="shortContentOfAppeal"></textarea>

      <label>Вид</label>
      <select class="form-control" name="typeOfDeputeAppeal" path="typeOfDeputeAppeal">
      ...
      <textarea class="form-control" name="mainWorker" path="mainWorker"></textarea>
