...
<head>
  ...
  <link href="<c:url value="/resources/styles/mainStyles/mainPage.css" />" rel="stylesheet">

</head>

<body>

<c:url var="addUrl" value="/deputeAppeal/newDeputeAppeal"/>
<c:url var="searchAppeal" value="/main/GeneralSearchResult"/>
<c:url var="searchDeputeAppeal" value="/deputeAppeal/deputeAppealSearchPage"/>
    ...
    <div class = "col-md-12">
      ...
      <div class="btn-group first_button">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="${searchDeputeAppeal}">Пошук звернень (запитів) народних депутатів</a></li>
        </ul>
      </div>
...
<div class="container search_block">
  ...
  <form:form method="get" action="${searchAppeal}" accept-charset="UTF-8">


  <div class="col-md-offset-3 col-md-6">
    <p>Загальний пошук</p>
    <div class="input-group">
      <input type="text" class="form-control" placeholder="введіть слово для пошуку" name="searchingChar">
